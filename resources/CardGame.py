...
whites = ["caha.txt", "homebrewa.txt", "expansion1a.txt", "expansion2a.txt", "expansion3a.txt", "expansion4a.txt", "misca.txt"]
blacks = ["cahq.txt", "homebrewq.txt", "expansion1q.txt", "expansion2q.txt", "expansion3q.txt", "expansion4q.txt", "miscq.txt"]
