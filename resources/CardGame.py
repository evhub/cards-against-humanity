...
whites = ["caha.txt", "homebrewa.txt","expansiona.txt","expansion2a.txt","expansion3a.txt","expansion4a.txt"]
blacks = ["cahq.txt", "homebrewq.txt","expansionq.txt","expansion2q.txt","expansion3q.txt","expansion4q.txt"]
