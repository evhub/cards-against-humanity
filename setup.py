...
setuptools.setup(name="cah", version="0.0.1", url="https://github.com/evhub/cards-against-humanity", author="Evan Hubinger", author_email="evanjhub@gmail.com", packages=setuptools.find_packages())
